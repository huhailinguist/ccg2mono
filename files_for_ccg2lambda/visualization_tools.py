...
# latex to mathml: https://www.mathtowebonline.com/
# TODO now ETtypes are shifted to the right a little bit.
arrowplus_mathml = """
<mrow>
    <mover>
        <mo>&#x02192;</mo>
...
def get_polarity_mathml(polarity):
    return "<mtext " \
        + " fontsize='" + str(kOtherSize) + "'" \
        + " color='" + kPolarityColor + "'>" \
        + polarity \
        + "</mtext>\n"
